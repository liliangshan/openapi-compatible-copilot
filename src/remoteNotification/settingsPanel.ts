...
const TEXT: Record<ResolvedAppLanguage, Record<string, string>> = {
	...
	'zh-cn': {
		title: '远程办公设置', save: '保存', connect: '连接', enabled: '启用远程办公', websocket: '网络套接字', websocketEnabled: '启用网络套接字', websocketUrl: '网络套接字地址', webhook: '回调', webhookEnabled: '启用回调', webhookUrl: '回调地址', history: '聊天记录请求', allowHistoryRequest: '允许远端请求历史记录', saved: '远程办公设置已保存。',
	...
	'zh-tw': {
		title: '遠端辦公設定', save: '儲存', connect: '連線', enabled: '啟用遠端辦公', websocket: '網路通訊端', websocketEnabled: '啟用網路通訊端', websocketUrl: '網路通訊端位址', webhook: '回呼', webhookEnabled: '啟用回呼', webhookUrl: '回呼位址', history: '聊天紀錄請求', allowHistoryRequest: '允許遠端請求歷史紀錄', saved: '遠端辦公設定已儲存。',
	...
	ko: {
		title: '원격 근무 설정', save: '저장', connect: '연결', enabled: '원격 근무 사용', websocket: '웹소켓', websocketEnabled: '웹소켓 사용', websocketUrl: '웹소켓 주소', webhook: 'Webhook', webhookEnabled: 'Webhook 사용', webhookUrl: 'Webhook 주소', history: '채팅 기록 요청', allowHistoryRequest: '원격 기록 요청 허용', saved: '원격 근무 설정이 저장되었습니다.',
	...
	ja: {
		title: 'リモートワーク設定', save: '保存', connect: '接続', enabled: 'リモートワークを有効化', websocket: 'WebSocket', websocketEnabled: 'WebSocket を有効化', websocketUrl: 'WebSocket URL', webhook: 'Webhook', webhookEnabled: 'Webhook を有効化', webhookUrl: 'Webhook URL', history: 'チャット履歴リクエスト', allowHistoryRequest: 'リモート履歴リクエストを許可', saved: 'リモートワーク設定を保存しました。',
	...
	fr: {
		title: 'Paramètres du travail à distance', save: 'Enregistrer', connect: 'Connecter', enabled: 'Activer le travail à distance', websocket: 'WebSocket', websocketEnabled: 'Activer WebSocket', websocketUrl: 'URL WebSocket', webhook: 'Webhook', webhookEnabled: 'Activer Webhook', webhookUrl: 'URL Webhook', history: 'Demande d’historique de chat', allowHistoryRequest: 'Autoriser les demandes d’historique distantes', saved: 'Paramètres du travail à distance enregistrés.',
	...
	de: {
		title: 'Remote-Arbeit-Einstellungen', save: 'Speichern', connect: 'Verbinden', enabled: 'Remote-Arbeit aktivieren', websocket: 'WebSocket', websocketEnabled: 'WebSocket aktivieren', websocketUrl: 'WebSocket-URL', webhook: 'Webhook', webhookEnabled: 'Webhook aktivieren', webhookUrl: 'Webhook-URL', history: 'Chatverlaufsanfrage', allowHistoryRequest: 'Remote-Verlaufsanfragen erlauben', saved: 'Remote-Arbeit-Einstellungen gespeichert.',
...
input[type=text]{width:100%;box-sizing:border-box;background:var(--vscode-input-background);color:var(--vscode-input-foreground);border:1px solid var(--vscode-input-border);padding:6px}
...
for (const key of ['websocketUrl','webhookUrl']) document.getElementById(key).value = state[key] || '';
document.getElementById('save').addEventListener('click', () => {
  ...
  for (const key of ['websocketUrl','webhookUrl']) data[key] = document.getElementById(key).value;
